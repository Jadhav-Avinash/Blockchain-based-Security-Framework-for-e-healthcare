...
public class patientlogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            if (pid.equals(""))
                JOptionPane.showMessageDialog(this,"Enter PID!");
            else
            if (pass.equals(""))
            ...
            else
            {
                Connection con=new dbpack.dbconnect().connect();
                    ...
                    PreparedStatement pst=con.prepareStatement("select * from patient where pid=? and pass=?");
                    ...
                    {
                       this.dispose();
                    new patientmenu(Integer.parseInt(pid)).setVisible(true); 
                    }
                    else
                    {
